export const projectArray = [
  ...
  },
  {
    ...
    icon: "./nintendo-memory-icon.webp",
    background: "./nintendo-memory-ss.webp",
    description:
  ...
  },
  {
    ...
    icon: "./battleship-icon.webp",
    background: "./battleship-ss.webp",
    description:
